class Agentshield < Formula
  ...
  url "https://github.com/AI-AgentLens/agentshield-oss/archive/v0.2.0.tar.gz"
  sha256 ""
  license "Apache-2.0"
  ...
  def install
    ldflags = %W[
      ...
      -X github.com/AI-AgentLens/agentshield/internal/cli.GitCommit=#{tap.user}
      -X github.com/AI-AgentLens/agentshield/internal/cli.BuildDate=#{time.iso8601}
    ]
