...
#
# Usage:
#   cd agentshield-oss && ./scripts/install-local.sh
#   # or from anywhere:
#   ./path/to/agentshield-oss/scripts/install-local.sh
#
# Options:
...
LDFLAGS="${LDFLAGS} -X 'github.com/AI-AgentLens/agentshield/internal/cli.GitCommit=${GIT_COMMIT}'"
LDFLAGS="${LDFLAGS} -X 'github.com/AI-AgentLens/agentshield/internal/cli.BuildDate=${BUILD_DATE}'"
