...
**Current status**: 1334 test cases, 99.8% recall, 2 known false negatives tracked in `FAILING_TESTS.md`. Known gaps:
...
`taxonomy/` contains 150 YAML entries organized by 8 kingdoms, each mapping to OWASP LLM Top 10 2025. `internal/taxonomy/` handles loading and compliance index generation.
